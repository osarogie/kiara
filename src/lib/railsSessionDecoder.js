...
RailsSessionDecoder.prototype.setSignedCookieSalt = function(
  newSignedCookieSalt
) {
...
RailsSessionDecoder.prototype.decodeCookieFn = function(
  cookie,
  isSignedCookie,
  next
) {
  ...
  crypto.pbkdf2(
    ...
    function(err, derivedKey) {
      ...
      try {
        ...
        var decryptedData =
          decipher.update(data, 'binary', 'utf8') + decipher.final('utf8')
