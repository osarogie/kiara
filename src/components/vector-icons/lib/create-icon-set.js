...
import {
  ...
  processColor,
  Text,
} from 'components/vector-icons/lib/react-native';

import createIconButtonComponent from 'components/vector-icons/lib/icon-button';
import createTabBarItemIOSComponent from 'components/vector-icons/lib/tab-bar-item-ios';
import createToolbarAndroidComponent from 'components/vector-icons/lib/toolbar-android';
  ...
  function ensureNativeModuleAvailable() {
    if (!NativeIconAPI) {
      if (Platform.OS === 'android') {
        throw new Error(
          'RNVectorIconsModule not available, did you properly integrate the module? Try running `react-native link components/vector-icons` and recompiling.'
        );
      }
      throw new Error(
        'RNVectorIconsManager not available, did you add the library to your project and link with libRNVectorIcons.a? Try running `react-native link components/vector-icons` and recompiling.'
      );
    }
  }
