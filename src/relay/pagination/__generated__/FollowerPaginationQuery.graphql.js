/**
 * @flow
 * @relayHash 73d9c6d87e4bb335f00741bec4b127d6
 */
...
type FollowerPagination_user$ref = any;
...
export type FollowerPaginationQuery = {|
  variables: FollowerPaginationQueryVariables,
  response: FollowerPaginationQueryResponse,
|};
*/
...
return {
    ...
    "selections": [
      {
        ...
        "selections": [
          ...
          },
          {
            ...
            "args": (v2/*: any*/),
            "handle": "connection",
            "key": "FollowerPagination_followers",
            "filters": null
          },
          (v3/*: any*/)
        ]
  ...
  "params": {
    ...
    "name": "FollowerPaginationQuery",
    "id": null,
    "text": "query FollowerPaginationQuery(\n  $count: Int!\n  $cursor: String\n  $id: ID!\n) {\n  user(id: $id) {\n    ...FollowerPagination_user\n    id\n  }\n}\n\nfragment FollowerPagination_user on User {\n  followers(first: $count, after: $cursor) {\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    edges {\n      node {\n        id\n        ...UserListItem_user\n        __typename\n      }\n      cursor\n    }\n  }\n}\n\nfragment UserListItem_user on User {\n  id\n  _id\n  name\n  username\n  bio\n  profilePictureName\n  ...FollowButton_user\n}\n\nfragment FollowButton_user on User {\n  _id\n  name\n  viewerFollows\n  followsViewer\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '629fc4c2b927b98018f4f9de14b5190f';
module.exports = node;
