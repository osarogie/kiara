...
export type DiscoverSQueryVariables = {
    count: number;
    cursor?: string | null;
    q?: string | null;
};
export type DiscoverSQueryResponse = {
    readonly feed: {
        readonly " $fragmentRefs": FragmentRefs<"Discover_discussionList">;
    } | null;
};
export type DiscoverSQuery = {
    readonly response: DiscoverSQueryResponse;
    readonly variables: DiscoverSQueryVariables;
};



/*
query DiscoverSQuery(
  $count: Int!
  $cursor: String
  $q: String
) {
