...
export type CultureScreenQueryVariables = {
    count: number;
    cursor?: string | null;
    id: string;
};
export type CultureScreenQueryResponse = {
    readonly group: {
        readonly " $fragmentRefs": FragmentRefs<"Group_group" | "Group_discussionList">;
    } | null;
};
export type CultureScreenQuery = {
    readonly response: CultureScreenQueryResponse;
    readonly variables: CultureScreenQueryVariables;
};



/*
query CultureScreenQuery(
  $count: Int!
  $cursor: String
  $id: ID!
) {
