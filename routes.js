...
routes.add('/c/[permalink]', 'groups/group')
routes.add('/c/:permalink', 'groups/group')
...
routes.add('/[userId]', 'users/user')
routes.add('/user/:userId', 'users/user')
routes.add('/:userId', 'users/user')

// routes.add('/:username/:id/:permalink', 'posts/post')
routes.add('/[userId]/[discussionId]/[discussionSlug]', 'posts/post')
