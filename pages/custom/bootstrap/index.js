  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="icon"
          href="//getbootstrap.com/docs/4.0///getbootstrap.com/docs/4.0/favicon.ico"
        />
        ...
        <link
          rel="canonical"
          href="//getbootstrap.com/docs/4.0/examples/blog/"
        />

        <link
          href="//getbootstrap.com/docs/4.0/dist/css/bootstrap.min.css"
          rel="stylesheet"
        />

        <link
          href="//fonts.googleapis.com/css?family=Playfair+Display:700,900"
          rel="stylesheet"
        />
      ...
      <footer className="blog-footer">
        <p>
          Blog template built for <a href="//getbootstrap.com/">Bootstrap</a> by{' '}
    ...
    window.jQuery || document.write('<script src="//getbootstrap.com/docs/4.0/assets/js/vendor/jquery-slim.min.js"><\/script>')
    `}
      />
      <script src="//getbootstrap.com/docs/4.0/assets/js/vendor/popper.min.js" />
      <script src="//getbootstrap.com/docs/4.0/dist/js/bootstrap.min.js" />
      <script src="//getbootstrap.com/docs/4.0/assets/js/vendor/holder.min.js" />
      <script
        dangerouslySetInnerHTML={`
